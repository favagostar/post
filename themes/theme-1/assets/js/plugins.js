...
function formValidation(){
    if($('.form-validation').length && $.fn.validate){
        ...
        $.validator.methods.nationalcode = function(value, element) {
            if (!/^\d{10}$/.test(value)
                || value=='0000000000'
                || value=='1111111111'
                || value=='2222222222'
        ...
        $('.form-validation').each(function(){
            var formValidation = $(this).validate({
                ...
                rules: {       
                    ...
                    username: {nationalcode: true},
                    mobile: {pattern: /^[0][9][0-9]{9}$/},                    
                    password: {minlength: 4, maxlength: 50},
                    password_confirmation: {equalTo: '#password'},
                    calcul: {operation: 12},
                    url: {url: true}
                },
                messages:{
                    username: {required: 'کد ملی خود را وارد کنید', nationalcode: 'فرمت کد ملی وارد شده نامعتبر است'},
                    lastName: {required: 'نام خانوادگی خود را وارد کنید', maxlength: 'نام خانوادگی نباید بیشتر از 50 حرف باشد'},
                    firstName: {required: 'نام خود را وارد کنید', maxlength: 'نام نباید بیشتر از 50 حرف باشد'},
                    email: {required: 'پست الکترونیک خود را وارد کنید', email: 'یک پست الکترونیک معتبر وارد کنید'},
                    language: {required: 'Enter your language'},
                    mobile: {required: 'شماره موبایل خود را وارد کنید', pattern: 'فرمت شماره موبایل وارد شده نامعتبر است'},
                    avatar: {required: 'You must upload your avatar'},
                    organization: {required: 'لطفا دستگاه اجرایی خود را انتخاب کنید'},
                    password: {required: 'رمز عبور خود را وارد کنید', minlength: 'رمز عبور باید بیشتر از 4 حرف باشد', maxlength: 'رمز عبور نباید بیشتر از 50 حرف باشد'},
                    password_confirmation: {required: 'تکرار رمز عبور خود را وارد کنید',equalTo: 'رمز عبور با تکرارش باید یکسان باشد'},
